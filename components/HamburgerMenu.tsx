...
import { HoveredLink, NavHoveredLink } from "@/components/ui/NavBar-Menu"; // Assuming you have these components already
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="relative">
              <a href="/student-visa" className="text-black" onClick={toggleMenu}>Student Visa</a>
              <button
            ...
            <div className="relative">
              <a href="/migration" className="text-black" onClick={toggleMenu}>Migration</a>
              <button
            ...
            <div className="relative">
              <a href="/contact-us" className="text-black" onClick={toggleMenu}>Contact Us</a>
              <button
